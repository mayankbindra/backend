...
export default function Listing(props) {
    ...
    const deleteRecord = (record, e) => {
        if (confirm("Are you sure you want to delete this testimonial?")) {
            Inertia.delete(route('testimonials.destroy', record.id));
            setEditData({});
            setRandomToken('');
        }
    };
    ...
    return (
        ...
        >
                <div className="row" id="table-hover-row">
                                            ...
                                            <td>
                                                <div className="avatar-group">
                                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" className="avatar pull-up my-0" title="Lilian Nenez">
                                                        <img src={baseUrl+'/uploads/testimonials/'+record.image} alt="Avatar" height="26" width="26" />
                                                    </div>
                                                </div>
                                            </td>
                    ...
                    <TestimonialForm token={randomToken} editData={editData} />
                </div>
